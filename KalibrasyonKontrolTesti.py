...
def check_calibration_factors(file_path, device_sn, firmware_version, device_name, ref_matrix_acc, ref_matrix_gyro, ref_matrix_magn):
...
def KalibrasyonKontrolTesti(dlg, base_path, device_sn, firmware_version, device_name, ref_matrix_acc, ref_matrix_gyro, ref_matrix_magn, kalibrasyon_kontrol_folder):
    ...
    results = check_calibration_factors(config_path, device_sn, firmware_version, device_name, ref_matrix_acc, ref_matrix_gyro, ref_matrix_magn)
